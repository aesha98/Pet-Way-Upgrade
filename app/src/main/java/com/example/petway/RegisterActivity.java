...
public class RegisterActivity extends AppCompatActivity {
    ...
    private Button create_account_btn, login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create_account_btn = (Button) findViewById(R.id.btnRegisterReg);
        login = (Button) findViewById(R.id.btnRegisterReg);
...
//
        ...
        create_account_btn.setOnClickListener(view -> {
            ...
            {
                mFirebaseAuth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(RegisterActivity.this, task -> {
                    ...
                    if (task.isComplete())
                    {
                        ...
                        AddUserToDatabase(name, phone, email, userKey);
                        gotomainpage();
                    }
                    else
                    {
    ...
    {
        Intent intent = new Intent(RegisterActivity.this, activity_home.class);
    ...
    private void AddUserToDatabase(final String name, final String phone, final String email, final  String userUID) {
        ...
        rootReff.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child("Users").child(userUID).exists())) {
                    ...
                    rootReff.child("Users").child(userUID).updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
